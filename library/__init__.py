...
app.secret_key = "superman"  # Example secret key for Flask sessions
# TO FIND IT USE FLASK_UNSIGN:
# flask-unsign --decode --cookie 'eyJiZW51dHplcklkIjoiMSIsImJlbnV0emVybmFtZSI6ImZ1YnNpIn0.aEu4EA.vP_S3Pes-qzQQ8bdl9BmQAaWpxE'
